...
def run_analysis():
    ...
    if not os.path.exists('model_comparison_30d.csv'):
        print("Error: model_comparison_30d.csv not found. Please run ml_bid_optimizer.py and compare_models.py first.")
        return
        
    comp_df = pd.read_csv('model_comparison_30d.csv')
    ...
    # 6. Output to CSV
    output_file = 's2c_analysis_30d.csv'
