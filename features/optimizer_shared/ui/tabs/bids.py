...
def render_bids_tab(
    ...
    st.markdown(
        """
        <style>
        /* Keep Reason fully readable in bid tables */
        ...
        div[data-testid="stDataFrame"] [role="columnheader"][title="Reason"] {
    ...
    preferred_cols = ["Targeting", "Reason", "Campaign Name", "Match Type", "Clicks", "Orders", "Sales", "ROAS", "Ad Group Default Bid", "Bid", "CPC", "New Bid", "Decision_Basis", "Bucket"]
        ...
        if df is not None and not df.empty:
            ...
            st.data_editor(
                ...
                column_config={
                    ...
                    "Targeting": st.column_config.TextColumn("Targeting", width="medium"),
                }
            )
        else:
